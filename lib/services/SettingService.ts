  ...
  async getLLMProviderConfigs(): Promise<LLMProviderConfig[]> {
    return [
      ...
      },
      {
        ...
        modelsEndpoint: 'https://bedrock.us-east-1.amazonaws.com/foundation-models',
        apiKeyRequired: true,
        ...
        pricing: {
          ...
          modelPricing: {
            ...
            'meta.llama2-13b-chat-v1': { inputCostPer1k: 0.00075, outputCostPer1k: 0.001 },
            'meta.llama2-70b-chat-v1': { inputCostPer1k: 0.00195, outputCostPer1k: 0.00256 },
          },
        },
      },
      {
        ...
        modelsEndpoint: `${process.env.AZURE_OPENAI_ENDPOINT || ''}/openai/deployments?api-version=2024-02-15-preview`,
        apiKeyRequired: true,
        ...
        pricing: {
          ...
          outputCostPer1k: 0.0015,
          modelPricing: {
            'gpt-35-turbo': { inputCostPer1k: 0.0005, outputCostPer1k: 0.0015 },
            'gpt-35-turbo-16k': { inputCostPer1k: 0.003, outputCostPer1k: 0.004 },
            'gpt-4': { inputCostPer1k: 0.03, outputCostPer1k: 0.06 },
            'gpt-4-turbo': { inputCostPer1k: 0.01, outputCostPer1k: 0.03 },
          },
        },
