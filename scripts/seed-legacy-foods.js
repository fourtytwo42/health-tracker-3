...
async function seedLegacyFoods() {
  ...
  try {
    ...
    // The file contains a JSON object with SRLegacyFoods property
    const foodsArray = data.SRLegacyFoods || [];
    
    console.log(`Found ${foodsArray.length} legacy foods to process`);
    ...
    console.log(`Legacy foods seeding completed!`);
    console.log(`- Processed: ${processed}`);
    console.log(`- Created: ${created}`);
    console.log(`- Skipped: ${skipped}`);
    
  } catch (error) {
    console.error('Error reading or parsing legacy foods file:', error);
  }
}
...
module.exports = { seedLegacyFoods }; 