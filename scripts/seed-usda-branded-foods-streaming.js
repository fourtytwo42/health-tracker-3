...
async function seedUSDAFoods() {
  try {
    console.log('🌱 Starting USDA branded foods seeding (streaming)...\n');
    ...
    console.log('📖 Reading USDA data file (streaming)...');
    ...
    console.log(`📊 Found ${totalLines} food items to process\n`);
    ...
    for await (const line of rl) {
      try {
        ...
        if (processedCount % 1000 === 0) {
          console.log(`⏳ Processed ${processedCount}/${totalLines} items... (Added: ${addedCount}, Skipped: ${skippedCount})`);
        }
